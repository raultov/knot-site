...
import type { serverFeatures } from '@/data/serverFeatures'

export type ServerFeatureId = (typeof serverFeatures)[number]['id']

/**
 * Record<ServerFeatureId, ReactNode>: same contract as featureIcons —
 * a new server feature without an icon breaks the build.
 */
export const serverIcons: Record<ServerFeatureId, ReactNode> = {
  'rest-api': (
    <svg
      viewBox="0 0 24 24"
      fill="none"
